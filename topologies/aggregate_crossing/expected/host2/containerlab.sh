...
run_worker_deploy() {
  :
  $SUDO ovs-vsctl --may-exist add-br sw1_host2 || note_failure "create bridge sw1_host2"
}
...
run_worker_destroy() {
  :
  $SUDO ovs-vsctl --if-exists del-br sw1_host2 || note_failure "delete bridge sw1_host2"
}
