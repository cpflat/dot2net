...
run_worker_deploy_pre() {
  ...
  if $SUDO ovs-vsctl br-exists br-ae63ed; then
    note_failure "bridge br-ae63ed already exists: destroy the lab that made it, or remove it by hand"
  else
    $SUDO ovs-vsctl add-br br-ae63ed || note_failure "create bridge br-ae63ed"
  fi
}
...
run_worker_destroy_post() {
  :
  $SUDO ovs-vsctl --if-exists del-br br-ae63ed || note_failure "delete bridge br-ae63ed"
}
